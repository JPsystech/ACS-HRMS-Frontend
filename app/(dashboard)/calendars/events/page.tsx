...
export default function CompanyEventsPage() {
  ...
  const handleEdit = (ev: CompanyEvent) => {
    ...
    setImageFile(null)
    setImagePreview(normalizeImageUrl(ev.image_url ?? "") || null)
    setUploadError("")
    setEditOpen(true)
  }
  ...
  const handleSubmitCreate = async () => {
    ...
    try {
      ...
      const created = await api.post<CompanyEvent>("/api/v1/events", { ...formData, image_url: normalizeImageUrl(formData.image_url) || undefined })
  ...
  const handleSubmitEdit = async () => {
    ...
    try {
      const updateData: CompanyEventUpdate = {
        ...
        image_url: normalizeImageUrl(formData.image_url) || undefined,
