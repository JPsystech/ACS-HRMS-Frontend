...
const breadcrumbMap: Record<string, string> = {
  ...
  "/admin/payroll/salary-master": "Salary Master",
  "/admin/payroll/salary-master/new": "Create Salary Master",
  "/admin/payroll/reminders": "Payroll Reminders",
  "/admin/payroll/email-settings": "Payroll Email Settings",
